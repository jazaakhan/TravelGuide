...
if(isset($_POST['btnforgotpasslogin']))
{
	...
	if(mysqli_num_rows($qsqlcust) == 1)
	{
		...
		Someone has requested a new password for the following account on Free Friendly Travel Mood:<br><br>
		...
		Thanks for reading.<br><br><b>- Free Friendly Travel Mood</b>";
...
<head>
		...
		<title> Free Friendly Travel Mood</title>
		<!-- Bootstrap -->
		...
		<div class="iqoniq_wrapper">
			...
			<header class="mg_header_1">
				...
				<div class="mg_nav_wrapper">
                    <!-- iqoniq Logo Start-->
					<div class="mg_logo">
                        <a href="index.php"><img src="images/travellogo.png" alt="" style="height: 70px;"/></a>
                    </div>
                    <!-- iqoniq Logo End-->
