                ...
                <div class="container">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="widget widget_text">
                            <div class="logo">
                                <a href="#"><img src="images/travellogo.png" alt="" style="height: 70px;" /></a>
                            </div>
                            <div class="text">
                                <p>This website provide complete information about tourism places with facilities, location map, contact details. Even it allows customer to book lodges through online.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Widget Text End--> 
...
<i class="fa fa-phone"></i><span> +91-9874566789</span>
<hr>
</div>
...
if(!isset($_SESSION['staffid']))
{
	...
	{
?>
 <a class="mg_login_btn" data-toggle="modal" data-target="#StaffLoginModal" href="#">Staff Login</a>
<?php	
	}
}
?>
